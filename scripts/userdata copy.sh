...
sudo git clone -b installations https://github.com/Sompassate/Fully-Automated-CICD-Infra.git
sudo cp /tmp/Fully-Automated-CICD-Infra/prometheus-setup-dependencies/node-exporter.service /etc/systemd/system/node-exporter.service
